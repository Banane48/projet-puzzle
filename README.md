...
# Introduction
Dans le cadre de notre formation, nous avons du réaliser le projet puzzle bot. Le but de ce projet est la création d'une machine capable de réaliser un puzzle.
# Matériels utilisés
